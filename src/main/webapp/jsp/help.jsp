                        ...
                        <div class="accordion" id="helpAccordion">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="help1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        Navigate to <strong>Reservations</strong> → Click <strong>New
                                            Reservation</strong>.
                                        Select an available room and enter guest details such as name, contact info, and
                                        stay duration.
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="help3" class="accordion-collapse collapse" data-bs-parent="#helpAccordion">
                                    <div class="accordion-body">
                                        ...
                                        Go to <strong>Rooms</strong> → <strong>Manage Room Types</strong> to add,
                                        update, or set availability.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="help4" class="accordion-collapse collapse" data-bs-parent="#helpAccordion">
                                    <div class="accordion-body">
                                        Guest address details are mandatory when creating a reservation: Street, City,
                                        State, Zip, Country.
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="help9" class="accordion-collapse collapse" data-bs-parent="#helpAccordion">
                                    <div class="accordion-body">
                                        ...
                                        <ul class="mt-2">
                                            <li>Email: <a
                                                    href="mailto:support@oceanviewresort.com">support@oceanviewresort.com</a>
                                            </li>
