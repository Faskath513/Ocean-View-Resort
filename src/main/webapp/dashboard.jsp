        ...
        <div class="row mt-4">
            <div class="col-md-4">
                <div class="card p-3 mb-2">
                    ...
                    <a href="${pageContext.request.contextPath}/reservations" class="btn btn-outline-primary">View
                        All</a>
                </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="card p-3 mb-2">
                    ...
                    <a href="${pageContext.request.contextPath}/reports" class="btn btn-outline-primary">View
                        Reports</a>
                </div>
            </div>
        </div>
        <div class="row mt-2">
            <div class="col-md-12">
                <div class="card p-3 mb-2">
                    ...
                    <a href="${pageContext.request.contextPath}/jsp/help.jsp" class="btn btn-outline-secondary">View
                        Help</a>
                </div>
            </div>
        </div>
